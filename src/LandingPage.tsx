...
// ═══════════════════════════════════════════════════════════
// Landing Page — eigenes lazy geladenes Modul, damit
// framer-motion nicht im Initial-Bundle der App landet.
// ═══════════════════════════════════════════════════════════
...
export default function LandingPage({ onOpenLogin }: { onOpenLogin: (email?: string) => void }) {
      ...
      <div className="landing-content">
        ...
        <nav className={`landing-nav ${navScrolled ? "scrolled" : ""}`}>
          ...
          <div className="landing-nav-links">
            ...
            <button className="landing-nav-login" onClick={() => onOpenLogin()}>Einloggen</button>
        ...
        {mobileNavOpen && (
          <>
            ...
            <div className="landing-nav-mobile-drawer open">
              ...
              <button className="btn btn-sm" onClick={() => { onOpenLogin(); setMobileNavOpen(false); }}>Einloggen</button>
        ...
        <motion.section className="hero" id="start" style={{ y: heroY }}>
          ...
          >
            ...
            <SignupCta ctaLabel="Kostenlos starten" onDevLogin={(email) => onOpenLogin(email)} />
        ...
        >
          ...
          <div className="faq-list">
            {[
              { q: "Ist Faktox wirklich kostenlos?", a: "Ja. Der Free-Plan mit 3 Rechnungen und 3 Aufträgen pro Monat ist dauerhaft kostenlos — ohne Kreditkarte. Erst wenn du mehr brauchst, lohnt sich Starter (29€/Monat)." },
